...
public class TransactionsEx2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // arquivo de saida
        Path output = new Path("output/TransactionsEx2.txt");

        // criacao do job e seu nome
        Job j = new Job(c, "TransactionsEx2");

        // registro das classes
        j.setJarByClass(TransactionsEx2.class);
        j.setMapperClass(MapForTransactionsEx2.class);
        j.setReducerClass(ReduceForTransactionsEx2.class);
     ...
     *                       Tipo da saida>
     */
    public static class MapForTransactionsEx2 extends Mapper<LongWritable, Text, Text, IntWritable> {
        ...
        public void map(LongWritable key, Text value, Context con)
            ...
            Text outputKey = new Text(ano.concat("-").concat(fluxo));
     ...
     */
    public static class ReduceForTransactionsEx2 extends Reducer<Text, IntWritable, Text, IntWritable> {
